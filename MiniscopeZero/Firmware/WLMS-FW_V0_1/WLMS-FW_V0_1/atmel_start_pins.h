...
#define SPI_BB_MOSI GPIO(GPIO_PORTA, 4)
#define SPI_BB_SCK GPIO(GPIO_PORTA, 5)
#define SPI_BB_MISO GPIO(GPIO_PORTA, 6)
...
#define WPT_VOLT GPIO(GPIO_PORTB, 8)
#define LED_STATUS GPIO(GPIO_PORTB, 9)
#define SPI_BB_NSS GPIO(GPIO_PORTB, 12)
